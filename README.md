...
**Pure Speed. Zero Compromise. 1.0 Release**
...
### Desktop Environment
- Modern windowed GUI with taskbar and dock
...
*The AurionOS desktop with taskbar, dock, and application windows*

### Blaze Browser
![Browser](assets/1.png)
*Blaze browser rendering HTML with CSS styling*

### DOS Mode
![Terminal](assets/2.png)
*Classic command-line interface with full shell capabilities*

### Applications
![Apps](assets/3.png)
*Paint, Calculator, File Manager, and other built-in applications*

### System Info
![System](assets/4.png)
*Hardware detection and system statistics*

### Installer
![Installer](assets/5.png)
*Guided installation wizard with app selection*

> **Note**: Run AurionOS and capture your own screenshots to replace these placeholders
...
| VirtualBox | Full Support | VBE graphics mode |
| Real Hardware (PS/2) | Full Support | Tested on various PCs |
...
**AurionOS 1.0 Release**

*Built with passion. Runs with purpose.*

---

Application icons sourced from [Flaticon](https://www.flaticon.com)
